...
exports.isLoggedIn = (req, res, next) => {
  // first checked if the user is authenticated
  if(req.isAuthenticated()) {
    next(); //carry on! Thet are logged in!
    return;
  }
...
exports.reset = async (req, res) => {
  ...
  // if there is there is a user, show the reset password form
...
const setPassword = promosify(user.setPassword, user);
